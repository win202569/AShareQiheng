...
TEMPLATES: dict[str, TemplateDefinition] = {
    ...
    "real_estate_high_leverage": TemplateDefinition("real_estate_high_leverage", _COMMON_FINANCIAL_SLOTS, True),
    "resource_cycle": TemplateDefinition("resource_cycle", _COMMON_FINANCIAL_SLOTS, True),
