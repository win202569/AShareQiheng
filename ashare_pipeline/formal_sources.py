...
def _make_range_registry_authority():
    """Keep genuine registry anchors independent of replaceable public aliases."""

    registry_type = SignedSourceRegistry
    require_verified = SignedSourceRegistry._require_verified
    range_snapshots = SignedSourceRegistry._trusted_range_config_snapshots

    def authority():
        return registry_type, require_verified, range_snapshots

    return authority


_range_registry_authority = _make_range_registry_authority()
del _make_range_registry_authority
